...
const addPremiumBlog = async (req , res)=>{
...
const showPremiumBlogs = async (req , res)=>{
...
const showSinglePrmiumBlog = async (req , res)=>{
...
const updatePremiumBlog = async (req , res)=>{
...
const deletPremiumBlog = async (req , res)=>{
